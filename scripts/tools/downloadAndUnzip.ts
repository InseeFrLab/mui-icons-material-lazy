...
function chunks<T>(arr: T[], size = 2) {
...
async function getFetchOptions(): Promise<
    Pick<FetchOptions, "proxy" | "noProxy" | "strictSSL" | "ca" | "cert">
> {
...
export async function downloadAndUnzip(
    ...
    const cacheRoot = !rest.doUseCache
        ...
        : pathJoin(
              process.env.XDG_CACHE_HOME ?? pathJoin(rest.projectDirPath, "node_modules", ".cache"),
              "downloadAndUnzip"
          );
